...
<body id="bodyHome">
  <header id="banner">
    ...
    <nav id="barraNavHome">
      ...
      <div class="botonIngresoRegistro">
        ...
        <input class="botIngresoRegistro" type="button" name="registro" value="Registrarse"
          onclick="location='registro.php'">
    ...
    <h1 id="titleHome"> <b>Digital Store Che</b> </h1>
  </header>
  ...
  <footer>
    ...
    <p id="infoHome"><br> Tel: 2614269628. <br><br> Cel: 2612388981. <br><br> Direccion:
      Niñas de Ayohuma 1395 Guaymallen Mendoza. <br> <br>CopyRight &copy 2020 Republica Argentina. </p>
